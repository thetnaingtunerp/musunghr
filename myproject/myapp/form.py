...
class employee_profile_form(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'contract_id': forms.TextInput(attrs={'class': 'form-control col-md-6', 'placeholder':'Contract ID'}),
            'finger_id': forms.TextInput(attrs={'class': 'form-control col-md-6', 'placeholder':'Finger ID'}),
            ...
            'race': forms.TextInput(attrs={'class': 'form-control col-md-6', 'placeholder':''}),
            'religion': forms.TextInput(attrs={'class': 'form-control col-md-6', 'placeholder':''}),
                        
            'dob': forms.DateInput(attrs={'class': 'form-control col-md-6', 'type':'date'}),
            'marital': forms.Select(attrs={'class': 'form-control col-md-4 custom-select2'}),
            ...
            'type': forms.Select(attrs={'class': 'form-control col-md-4 custom-select2'}),
            ...
            'district': forms.TextInput(attrs={'class': 'form-control col-md-6', 'placeholder':''}),
